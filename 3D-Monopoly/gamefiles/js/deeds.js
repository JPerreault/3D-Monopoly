...
function askToBuy(property)
{	
	intents = true;
	var relativeDiv = property.getPrettyDeed();
	relativeDiv = relativeDiv.replace("<div", "<div style=\"position:relative\" ");
